    ...
    <div className="bg-[#050608] min-h-screen text-white selection:bg-brand-yellow selection:text-black">
      ...
      <section className="relative min-h-[50vh] flex flex-col items-center justify-center pt-48 pb-20 px-6 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center flex flex-col items-center">
          ...
          >
            <Mail size={12} className="text-brand-yellow animate-bounce" />
                      ...
                      <div className="space-y-4 pt-4 border-t border-white/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div 
                            ...
                            className={`p-4 rounded-xl border flex flex-col justify-between cursor-pointer transition-all min-h-[90px] ${
                              subPress 
                          ...
                          >
                            <div className="flex justify-between items-center w-full">
                              ...
                              <div className={`w-4 h-4 rounded flex items-center justify-center border transition-all ${
                                subPress ? 'border-brand-yellow bg-brand-yellow text-black' : 'border-white/10'
                              }`}>
                          ...
                          >
                            <div className="flex justify-between items-center w-full">
                              ...
                              <div className={`w-4 h-4 rounded flex items-center justify-center border transition-all ${
                                subSec ? 'border-brand-yellow bg-brand-yellow text-black' : 'border-white/10'
                              }`}>
                          ...
                          >
                            <div className="flex justify-between items-center w-full">
                              ...
                              <div className={`w-4 h-4 rounded flex items-center justify-center border transition-all ${
                                subStock ? 'border-brand-yellow bg-brand-yellow text-black' : 'border-white/10'
                              }`}>
