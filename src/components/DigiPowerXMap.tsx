...
const DigiPowerXMap = () => {
    ...
    const buildPins = () => {
      SITES.forEach((s, idx) => {
        ...
        el.style.cssText =
          ...
          "background:rgba(0,0,0,.84);border:1px solid rgba(255,196,0,.6);" +
          "border-left:3px solid #FFC400;padding:5px 9px;white-space:nowrap;" +
  ...
  return (
    <div ref={containerRef} className="dpxmap">
