          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="bg-[#eef2f5] border border-slate-200/60 rounded-3xl p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.03)] relative w-full max-w-md">
                ...
                {/* Inner Crisp Blueprint Mockup Frame */}
                <div className="bg-white border border-slate-300 p-6 md:p-8 rounded-lg shadow-sm flex flex-col justify-between aspect-[1/1.4] w-full font-sans text-center relative">
                  <div className="text-left pb-3 border-b border-slate-100 flex justify-between items-start">
                    <div>
                      ...
                      <h4 className="text-[11px] font-black text-slate-800 uppercase tracking-tight mt-0.5">TECHNICAL BLUEPRINT</h4>
                    </div>
                    <span className="text-[7.5px] bg-[#f5c518]/10 text-[#d4a313] border border-[#f5c518]/25 font-mono px-2 py-0.5 rounded uppercase font-bold tracking-tight">ENCLOSURE v4</span>
                  </div>
                  
                  {/* Interactive Enclosure Image view */}
                  <div className="flex-1 flex items-center justify-center p-4 bg-slate-50 border border-slate-100/80 rounded-md my-4 overflow-hidden relative group">
                    <img 
                      src="/images/arms.webp" 
                      alt="ARMS 200 System Schematic Enclosure" 
                      className="max-h-full max-w-full object-contain rounded drop-shadow-[0_8px_24px_rgba(0,0,0,0.08)] hover:scale-105 transition-transform duration-700" 
                    />
                    <div className="absolute bottom-2 right-2 bg-black/60 backdrop-blur-md text-[6px] text-white/90 font-mono px-2 py-1 rounded tracking-widest uppercase">
                      bare-metal hardware preview
                    </div>
                  </div>

                  <div className="pt-3 border-t border-slate-100 flex justify-between items-center text-[7px] font-mono text-slate-400">
                    <span>MODEL: ARMS-200-SYS</span>
                    <span>SPECIFICATION: 600KW IT LOAD</span>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-6 max-w-[1400px] relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-6xl mx-auto items-stretch">
            ...
            <div className="lg:col-span-6 flex flex-col text-left">
              ...
              <div className="flex-1 bg-gradient-to-br from-[#0c0d0a]/90 via-[#070806]/95 to-[#0b0c0a]/90 border border-white/10 rounded-3xl p-8 relative shadow-[0_20px_50px_rgba(0,0,0,0.4)] overflow-hidden flex flex-col justify-between group hover:border-[#f5c518]/25 transition-all duration-500">
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between py-3 border-b border-white/5 last:border-b-0">
                      <div className="flex items-center gap-4 text-left">
                        ...
                        <span className="text-xs font-semibold text-white/70 uppercase tracking-wider">{spec.label}</span>
                      </div>
                      <div className="flex items-center gap-6">
                        <div className="w-[1px] h-6 bg-white/10" />
                        <span className="text-xs font-extrabold text-[#f5c518] text-right whitespace-pre-line leading-relaxed uppercase tracking-wider font-mono min-w-[160px]">
                          {spec.val}
                        </span>
                      </div>
                    </div>
            ...
            <div className="lg:col-span-6 flex flex-col gap-8 text-left">
              <div>
                ...
                <div className="bg-gradient-to-br from-[#0c0d0a]/90 via-[#070806]/95 to-[#0b0c0a]/90 border border-white/10 rounded-3xl p-8 relative shadow-[0_20px_50px_rgba(0,0,0,0.4)] overflow-hidden hover:border-[#f5c518]/25 transition-all duration-500 flex flex-col md:flex-row items-center gap-6">
                  ...
                  {/* Glowing 3D Matrix Cube Showcase */}
                  <div className="relative w-36 h-36 flex items-center justify-center bg-black/40 border border-white/5 rounded-2xl overflow-hidden group/cube">
              ...
              <div className="bg-gradient-to-br from-[#0c0d0a]/90 via-[#070806]/95 to-[#0b0c0a]/90 border border-white/10 rounded-3xl p-8 relative shadow-[0_20px_50px_rgba(0,0,0,0.4)] overflow-hidden hover:border-[#f5c518]/25 transition-all duration-500 flex flex-col justify-between text-left">
                ...
                <div className="space-y-4">
                  {/* Super Micro */}
                  <div className="flex items-center justify-between p-4 bg-black/40 border border-white/5 rounded-2xl hover:border-white/10 transition-colors">
                    <div className="flex items-center justify-center bg-white rounded-full px-4 py-2 w-28 h-10 shadow-sm border border-slate-200">
                      {/* Styled Supermicro wordmark matching logo */}
                      <span className="text-[#0055cc] font-sans font-black text-xs tracking-tighter">SUPER</span>
                      <span className="text-[#cc0000] font-sans font-black text-xs tracking-tighter">MICRO</span>
                    </div>
                  ...
                  {/* NVIDIA */}
                  <div className="flex items-center justify-between p-4 bg-black/40 border border-white/5 rounded-2xl hover:border-white/10 transition-colors">
                    <div className="flex items-center justify-center bg-black/80 rounded-full px-4 py-2 w-28 h-10 shadow-sm border border-white/10">
                      {/* Styled NVIDIA wordmark with green badge matching logo */}
                      <span className="text-[#76b900] font-sans font-extrabold text-xs tracking-widest uppercase mr-0.5">n</span>
                      <span className="text-white font-sans font-black text-xs tracking-wider uppercase">VIDIA</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="w-[1px] h-6 bg-white/10" />
                      <div className="text-right">
                        <span className="text-xs font-bold text-white block uppercase tracking-wide">NVIDIA</span>
                        <span className="text-[10px] font-bold text-[#f5c518] uppercase tracking-wider font-mono">GPU Acceleration And AI Compute</span>
                      </div>
                    </div>
                  </div>
                </div>
